...
%**************************************************************************
mu=2; MaG=1; G=1; kappa=1; R0=5;
% MaT=linspace(0,100,1001);

L1=-3; L2=3;
% MT=linspace(log10(L1),log10(L2),151);
% MaT=10.^(MT);
MaT=linspace(L1,L2,1551);
...
h(1)=plot(MaT,MigU1,'r','LineWidth',2,'Color',[0.8 0 0],'DisplayName','$S=0$'); hold on
h(2)=plot(MaT,MigU2,'b','LineWidth',2,'Color',[0.06,1.00,1.00],'DisplayName','$S=0.3$'); hold on
h(3)=plot(MaT,MigU3,'g','LineWidth',2,'Color',[0 0.5 0],'DisplayName','$S=0.6$'); hold on
h(4)=plot(MaT,MigU4,'k','LineWidth',2,'Color',[0 0 1],'DisplayName','$S=0.9$'); hold on
% h(5)=plot(MaT,MigU5,'k','LineWidth',2,'Color',[0.9 0 0.5],'DisplayName','$S=0.9$'); hold on

%
xlabel('$Ma_T$','interpreter','latex','fontsize',28);
