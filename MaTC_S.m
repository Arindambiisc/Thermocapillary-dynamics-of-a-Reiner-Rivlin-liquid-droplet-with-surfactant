...
h(1)=plot(S,MaT_star1,'r','LineWidth',2,'Color',[0.8 0 0],'DisplayName','$\kappa=0.1$'); hold on
h(2)=plot(S,MaT_star2,'b','LineWidth',2,'Color',[0 0 1],'DisplayName','$\kappa=1$'); hold on
h(3)=plot(S,MaT_star3,'g','LineWidth',2,'Color',[0 0.5 0],'DisplayName','$\kappa=10$'); hold on
